<%-- 
    ...
    Created on : 26-Sep-2017, 12:29:46 PM
    Author     : Vengor
--%>
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary fixed-top">
      <div class="container">
        <a class="navbar-brand" href="index.html">Bibliothèque Saint-Baudille</a>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
          <div class="card h-100">
              <a href="details.jsp"><img class="card-img-top" src="./img/TheEmptyThrone.jpg" alt="" height="300px"></a>
            <div class="card-body">
              <h4 class="card-title">
