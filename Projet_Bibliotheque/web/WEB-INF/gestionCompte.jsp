                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td><p class="card-text">${requestScope.compte.getNom()} ${requestScope.compte.getPrenom()}</p></td>
                            </tr>
                            <tr>
        ...
        <tbody>
            <c:forEach var="reservation" items="${requestScope.listeReservation}">
                <tr>
                    ...
                    <td>${reservation.getExemplaire().getEdition().getOuvrage().getAuteur().getNom()} ${reservation.getExemplaire().getEdition().getOuvrage().getAuteur().getPrenom()}</td>
        ...
        <tbody>
            <c:forEach var="emprunt" items="${requestScope.listeEmprunt}">
                        <tr>
                            ...
                            <td>${emprunt.getExemplaire().getEdition().getOuvrage().getAuteur().getNom()} ${reservation.getExemplaire().getEdition().getOuvrage().getAuteur().getPrenom()}</td>
